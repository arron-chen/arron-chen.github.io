...
http://www.a.com/a.js</br>
http://script.a.com/b.js      主域相同，子域不同        不允许（cookie这种情况下也不允许访问）</br>
http://www.a.com/a.js</br>
http://a.com/b.js             同一域名，不同二级域名（同上） 不允许（cookie这种情况下也不允许访问）</br>
...
假如父页面是 [baidu.com/a.html]() ,iframe 嵌入的页面为 [google.com/b.html]()（此处省略了域名等url属性），要实现此两个页面间的通信可以通过以下方法。
